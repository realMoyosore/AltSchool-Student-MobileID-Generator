...
document.getElementById("mobileID-generator").addEventListener("submit", async function (e) {
  ...
  // Footer
  doc.setFontSize(10);
  doc.text('Generated by AltSchool', 43, 52, { align: 'center' });
  doc.save(`${surname}-${firstName}-MobileID-withQRCode.pdf`);  
  alert("Mobile ID with QR Code generated and saved as PDF!");
  document.getElementById("mobileID-generator").reset();
